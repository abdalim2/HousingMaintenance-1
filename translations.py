...
translations = {
    'en': {
        ...
        'department_manager': 'Department Manager',
        'housing_maintenance_system': 'Housing Maintenance System',
        'timesheet_title': 'Monthly Timesheet',        'department': 'Department',
        'all_departments': 'All Departments',
        'all_housings': 'All Housing Locations',
        'month': 'Month',
        'year': 'Year',
        'view': 'View',
        'present': 'Present',
        ...
        'attendance_prediction_description': 'Predict future attendance patterns based on historical data.',
        'view_predictions': 'View Predictions',
        'employee_clustering': 'Employee Clustering',
        'employee_clustering_description': 'Group employees based on attendance patterns using unsupervised learning.',
        'view_clusters': 'View Clusters',
        'optimization_recommendations': 'Optimization Recommendations',
        'optimization_recommendations_description': 'Get AI-powered recommendations to improve attendance policies and workforce management.',
        'view_recommendations': 'View Recommendations',
        'ai_dashboard': 'AI Dashboard',
        'ai_dashboard_description': 'This dashboard provides an overview of the AI analytics capabilities. Click on specific sections above for detailed analysis.',
        ...
        'department_performance': 'Department Performance',
        'housing_performance': 'Housing Performance',
        'prepare_print': 'Prepare for Print',
        'print_now': 'Print Now',
    ...
    'ar': {
        ...
        'department_manager': 'مدير القسم',
        'housing_maintenance_system': 'نظام صيانة الإسكان',
        'timesheet_title': 'الجدول الزمني الشهري',        'department': 'القسم',
        'all_departments': 'جميع الأقسام',
        'all_housings': 'جميع المساكن',
        'month': 'الشهر',
        'year': 'السنة',
        'view': 'عرض',
        'present': 'حاضر',
        ...
        'attendance_prediction_description': 'التنبؤ بأنماط الحضور المستقبلية بناء على البيانات التاريخية.',
        'view_predictions': 'عرض التنبؤات',
        'employee_clustering': 'تجميع الموظفين حسب السلوك',
        'employee_clustering_description': 'استخدام خوارزميات التعلم غير الموجه لتجميع الموظفين بناءً على أنماط الحضور المتشابهة.',
        'view_clusters': 'عرض المجموعات',
        'optimization_recommendations': 'توصيات الحضور والانصراف',
        'optimization_recommendations_description': 'الحصول على توصيات ذكية لتحسين سياسات الحضور وإدارة القوى العاملة.',
        'view_recommendations': 'عرض التوصيات',
        'ai_dashboard': 'لوحة تحكم الذكاء الاصطناعي',
        'ai_dashboard_description': 'توفر لوحة المعلومات هذه نظرة عامة على إمكانيات تحليلات الذكاء الاصطناعي. انقر على أقسام محددة أعلاه للحصول على تحليل مفصل.',
        'anomalies_detected': 'الأنماط الشاذة المكتشفة',
        ...
        'housing_performance': 'أداء المساكن',
